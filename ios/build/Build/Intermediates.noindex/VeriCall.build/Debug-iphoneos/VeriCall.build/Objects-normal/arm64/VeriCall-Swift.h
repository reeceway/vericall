...
#ifndef VERICALL_SWIFT_H
#define VERICALL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VeriCall",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <ol>
///   <li>
///     Uncomment the VoIP/PushKit code below
///   </li>
///   <li>
///     Rename backend push_apns.py to push.py
///   </li>
///   <li>
///     Configure APNS_KEY_ID, APNS_TEAM_ID, APNS_KEY_CONTENT secrets on Fly.io
///   </li>
/// </ol>
SWIFT_CLASS("_TtC8VeriCall11AppDelegate")
...
SWIFT_CLASS("_TtC8VeriCall13AudioRecorder")
@interface AudioRecorder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVAudioRecorder;
@interface AudioRecorder (SWIFT_EXTENSION(VeriCall)) <AVAudioRecorderDelegate>
...
SWIFT_CLASS("_TtC8VeriCall14CallKitManager")
@interface CallKitManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC8VeriCall20CallWebSocketService")
@interface CallWebSocketService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@class NSString;
@interface CallWebSocketService (SWIFT_EXTENSION(VeriCall)) <NSURLSessionWebSocketDelegate>
...
/// <ol>
///   <li>
///     Rename this file to FirebasePushService_backup.swift
///   </li>
///   <li>
///     Rename PushKitService_apns.swift back to use PushKit
///   </li>
///   <li>
///     Update AppDelegate to use PushKit instead
///   </li>
/// </ol>
SWIFT_CLASS("_TtC8VeriCall19FirebasePushService")
@interface FirebasePushService : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC8VeriCall18NativeCallObserver")
@interface NativeCallObserver : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class CXCall;
@interface NativeCallObserver (SWIFT_EXTENSION(VeriCall)) <CXCallObserverDelegate>
...
SWIFT_CLASS("_TtC8VeriCall19NotificationService")
...
@interface NotificationService (SWIFT_EXTENSION(VeriCall)) <UNUserNotificationCenterDelegate>
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC8VeriCall19ShakeViewController")
...
SWIFT_CLASS("_TtC8VeriCall19VoiceCaptureService")
@interface VoiceCaptureService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface VoiceCaptureService (SWIFT_EXTENSION(VeriCall)) <AVAudioRecorderDelegate>
- (void)audioRecorderDidFinishRecording:(AVAudioRecorder * _Nonnull)recorder successfully:(BOOL)flag;
@end

SWIFT_CLASS("_TtC8VeriCall16WebSocketService")
...
@interface WebSocketService (SWIFT_EXTENSION(VeriCall)) <NSURLSessionWebSocketDelegate>
- (void)URLSession:(NSURLSession * _Nonnull)session webSocketTask:(NSURLSessionWebSocketTask * _Nonnull)webSocketTask didOpenWithProtocol:(NSString * _Nullable)protocol;
- (void)URLSession:(NSURLSession * _Nonnull)session webSocketTask:(NSURLSessionWebSocketTask * _Nonnull)webSocketTask didCloseWithCode:(NSURLSessionWebSocketCloseCode)closeCode reason:(NSData * _Nullable)reason;
